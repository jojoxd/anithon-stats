...
class Uuid extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Uuid', package: const $pb.PackageName(_omitMessageNames ? '' : 'anistats.ext'), createEmptyInstance: create)
