...
func Register(app core.Application, mgr router.Router) error {
	...
	err = mgr.Register(route.BindTypedFactory(routes.UserOverview, func() view.TypedView[v1.UserId] {
	...
	err = mgr.Register(route.BindTypedFactory(routes.UserLists, func() view.TypedView[v1.UserId] {
