...
const (
	PingService_Ping_FullMethodName = "/anistats.ping.PingService/Ping"
)
...
func (UnimplementedPingServiceServer) Ping(context.Context, *Ping) (*Pong, error) {
...
var PingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "anistats.ping.PingService",
